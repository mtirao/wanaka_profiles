...
/* package rel8-1.5.0.0 */
#ifndef VERSION_rel8
#define VERSION_rel8 "1.5.0.0"
#endif /* VERSION_rel8 */
#ifndef MIN_VERSION_rel8
#define MIN_VERSION_rel8(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  5 || \
  (major1) == 1 && (major2) == 5 && (minor) <= 0)
#endif /* MIN_VERSION_rel8 */
...
/* package warp-tls-3.4.9 */
#ifndef VERSION_warp_tls
#define VERSION_warp_tls "3.4.9"
...
#define CURRENT_COMPONENT_ID "profiles-0.1.0.0-Dq4EgfXbitTGzOqDucPkC0-profiles"
